...
export const reqToGetAgentDetail = createAsyncThunk("reqToGetAgentDetail", async (id) => {
    try {
        const response = await Axios.get(apiendpoints.getAgentDetail.replace(":id", id), userHeaders());
...
export const reqToTopAgent = createAsyncThunk("reqToTopAgent", async () => {
    try {
        const response = await Axios.get(apiendpoints.getTopAgentList, userHeaders());
...
export const reqToTopReview = createAsyncThunk("reqToTopReview", async () => {
    try {
        const response = await Axios.get(apiendpoints.getTopReview, userHeaders());
